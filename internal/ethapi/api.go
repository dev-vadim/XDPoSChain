...
// to other nodes
func (s *PrivateAccountAPI) SignTransaction(ctx context.Context, args SendTxArgs, passwd string) (*internal.SignTransactionResult, error) {
	...
	return &internal.SignTransactionResult{data, signed}, nil
}
...
func DoEstimateGas(ctx context.Context, b Backend, args CallArgs, blockNr rpc.BlockNumber, gasCap *big.Int) (hexutil.Uint64, error) {
	...
	executable := func(gas uint64) bool {
		...
		_, _, failed, err := DoCall(ctx, b, args, rpc.LatestBlockNumber, vm.Config{}, 0, gasCap)
		if err != nil || failed {
			return false
		}
		return true
...
func (s *PublicBlockChainAPI) EstimateGas(ctx context.Context, args CallArgs) (hexutil.Uint64, error) {
	return DoEstimateGas(ctx, s.b, args, rpc.LatestBlockNumber, s.b.RPCGasCap())
}
...
func (args *SendTxArgs) setDefaults(ctx context.Context, b Backend) error {
	...
	if args.Gas == nil {
		...
		estimated, err := DoEstimateGas(ctx, b, callArgs, rpc.LatestBlockNumber, b.RPCGasCap())
		if err != nil {
			return err
		}
		args.Gas = &estimated
...
func (s *PublicTransactionPoolAPI) SignTransaction(ctx context.Context, args SendTxArgs) (*internal.SignTransactionResult, error) {
	if args.Gas == nil {
		return nil, fmt.Errorf("gas not specified")
	}
	if args.GasPrice == nil {
	...
	return &internal.SignTransactionResult{data, tx}, nil
}
...
func (api *PublicDebugAPI) TestSignCliqueBlock(ctx context.Context, address common.Address, number uint64) (common.Address, error) {
	...
	sealHash := XDPoS.SealHash(header).Bytes()
