...
type ExternalAPI interface {
	...
	SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*internal.SignTransactionResult, error)
...
type UIClientAPI interface {
	...
	OnApprovedTx(tx internal.SignTransactionResult)
...
func (api *SignerAPI) SignTransaction(ctx context.Context, args SendTxArgs, methodSelector *string) (*internal.SignTransactionResult, error) {
	var (
		err    error
	...
	response := internal.SignTransactionResult{Raw: rlpdata, Tx: signedTx}
